...
/**
 * Servlet implementation class PassedManager
 */
@WebServlet("/PassedManager")
public class PassedManager extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String view = "/WEB-INF/view/passedmanager.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("http://localhost:8080/QualificationManagement/UserPassedManager");
	}
